    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ShopMart22.notify('Update role successful', 'success');
                    ...
                    error: function () {
                        ShopMart22.notify('Has an error', 'error');
                        ShopMart22.stopLoading();
                    }
                });
                return false;
        ...
        $('body').on('click', '.btn-delete', function (e) {
            ...
            ShopMart22.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    error: function (status) {
                        ShopMart22.notify('Has an error in deleting progress', 'error');
                        ShopMart22.stopLoading();
                    }
                });
            });
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ShopMart22.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    ShopMart22.stopLoading();
                },
                error: function () {
                    ShopMart22.notify('Has an error in save permission progress', 'error');
                    ShopMart22.stopLoading();
                }
            });
        });
