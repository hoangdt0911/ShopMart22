        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            ShopMart22.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        ShopMart22.notify('Deleted success', 'success');
                        ShopMart22.stopLoading();
                        loadData();
                    },
                    error: function (status) {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ShopMart22.notify('Update success', 'success');
                    ...
                    error: function () {
                        ShopMart22.notify('Has an error in update progress', 'error');
                        ShopMart22.stopLoading();
                    }
                });
            }
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var treeArr = ShopMart22.unflattern(data);
